...
export default {
  ...
  computed: {
    ...mapState(["fooddata"]),
    currentItem() {
      // so we used this to get the data from the spesific id that we used to creat the dynamic pages
      // we used 2 for loops instead of a filter for speed effciency since we can break when we hit a match
      let result;
